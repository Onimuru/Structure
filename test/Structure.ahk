...
loop, % (size := struct.Size)//4 {
	contents001 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents002 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents003 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents004 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents007 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents008 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents009 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
...
loop, % (size := struct.Size)//4 {
	contents011 .= NumGet(struct.Pointer + (A_Index - 1)*4, "UInt") . ((A_Index < size//4) ? (", ") : (""))  ;* Defaults to `"UInt"` type.
}
...
loop, % (size := struct.Size)//4 {
	contents012 .= NumGet(struct.Pointer + (A_Index - 1)*4, "Int") . ((A_Index < size//4) ? (", ") : (""))
}
